...
export const TRANSLATIONS: Record<string, Record<AppLanguage, string>> = {
  ...
  nav_services: { ka: 'სასტუმროს სერვისები', en: 'Hotel Services', ru: 'Услуги отеля' },
  ...
  services_title: { ka: 'სასტუმროს სერვისები', en: 'Hotel Services', ru: 'Услуги отеля' },
  menu_title: { ka: 'რესტორნის მენიუ', en: 'Restaurant Menu', ru: 'Меню ресторана' },
  guide_title: { ka: 'ადგილობრივი გზამკვლევი', en: 'Local Guide', ru: 'Локальный гид' },
  guide_open_maps: { ka: 'გახსენი Google Maps-ში', en: 'Open in Google Maps', ru: 'Открыть в Google Maps' },
  rules_title: { ka: 'წესები და კონტაქტი', en: 'Rules & Contact', ru: 'Правила и контакты' },
  rules_contacts_heading: { ka: 'საკონტაქტო ხაზები', en: 'Contact numbers', ru: 'Контактные номера' },
  ...
  admin_login_title: { ka: 'ადმინისტრატორის შესვლა', en: 'Admin sign in', ru: 'Вход администратора' },
