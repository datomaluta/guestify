...
@Component({
  ...
  styles: `
    .sub-header {
      ...
      position: sticky;
      // .app-body თავად სქროლავს (app-header ჩვეულებრივი, არასქროლადი flex-შვილია მის
      // ზემოთ და აღარ ედება კონტენტს) — sticky header ამ სქროლ-კონტეინერის თავზევე ეკვრება.
      top: 0;
      z-index: 5;
